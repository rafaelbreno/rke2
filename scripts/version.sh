...
KUBERNETES_IMAGE_TAG=${KUBERNETES_IMAGE_TAG:-v1.36.2-rke2r1-build20260613}
PAUSE_VERSION=${PAUSE_VERSION:-3.6}
CCM_VERSION=${CCM_VERSION:-v1.36.0-rc2.0.20260427154526-d239025e2a23-build20260429}
KLIPPERHELM_VERSION=${KLIPPERHELM_VERSION:-v0.10.0-build20260513}
KLIPPERLB_VERSION=${KLIPPERLB_VERSION:-v0.4.17}
