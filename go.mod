...
replace (
	...
	sigs.k8s.io/cri-tools => github.com/k3s-io/cri-tools v1.36.1-k3s1
)
...
require (
	...
	github.com/k3s-io/k3s v1.36.1-0.20260508014929-7bbbf7c9b258 // main
...
require (
	...
	github.com/Mirantis/cri-dockerd v0.3.19 // indirect
