...
replace (
	...
	github.com/Mirantis/cri-dockerd => github.com/k3s-io/cri-dockerd v0.3.15-k3s1.33.0
	...
	sigs.k8s.io/cri-tools => github.com/k3s-io/cri-tools v1.33.0-k3s1
)
...
require (
	...
	github.com/k3s-io/k3s v1.33.0-rc1.0.20250430074337-dc03cb4b3faa // master
